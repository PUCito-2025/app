    ...
    <div className="rounded-lg bg-white p-4 shadow">
      <div className="mb-4 flex items-center space-x-2">
        ...
        <button
          ...
          className="rounded-lg bg-gray-700 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800 focus:ring-2 focus:ring-gray-600 focus:ring-offset-2 focus:outline-none"
        >
